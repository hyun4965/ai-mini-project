...
TRL은 1~9 단계 기술 성숙도 기준이며, 본 보고서에서는 TRL 1~3을 기초 연구 단계, TRL 4~6을 실험 및 시연 단계, TRL 7~9를 상용화 및 양산 단계로 해석한다. 실제 실행 시 NASA 기반 TRL 9단계 구조 요약과 반도체 맥락에서의 적용 해석이 이 절에 채워진다.
