...
class StrategyConfig:
    ...
    retrieval_score_threshold: float = field(default_factory=lambda: float(os.getenv("TS_RETRIEVAL_SCORE_THRESHOLD", "0.45")))
    ...
    min_retrieved_docs: int = field(default_factory=lambda: int(os.getenv("TS_MIN_RETRIEVED_DOCS", "2")))
